...
(function () {
  ...
  var QUESTIONS = [
    ...
    { q: "Which scent family calls to you?", options: [
      { label: "Fresh & citrusy", s: { h24: 2, woodn: 2, green: 2, bdc: 1, erba: 1 } },
    ...
    { q: "Pick a season.", options: [
      ...
      { label: "Summer", s: { erba: 2, h24: 2, green: 1, woodn: 1 } },
    ...
    { q: "Which note draws you in?", options: [
      { label: "Citrus & bergamot", s: { sauv: 2, bdc: 2, h24: 1, erba: 1, green: 1 } },
