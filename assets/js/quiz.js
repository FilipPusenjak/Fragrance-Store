...
(function () {
  ...
  var PRIORITY = ["bdc", "sauv", "erba", "then", "jpg", "osm", "h24", "prada",
    "wildv", "green", "fire", "woodn", "ombra", "anim", "swy"];

  var QUESTIONS = [
    { q: "What's the occasion?", options: [
      { label: "Everyday & the office", s: { bdc: 2, prada: 2, h24: 2, then: 1, wildv: 1, woodn: 1 } },
      { label: "A date or a night out", s: { jpg: 2, anim: 2, sauv: 1, ombra: 1, osm: 1 } },
    ...
    { q: "Which scent family calls to you?", options: [
      ...
      { label: "Warm & spicy", s: { sauv: 2, ombra: 2, jpg: 1, anim: 1 } },
      { label: "Woody & earthy", s: { wildv: 2, then: 2, bdc: 1, prada: 1 } },
    ...
    { q: "Pick a season.", options: [
      ...
      { label: "Autumn", s: { then: 2, wildv: 2, bdc: 1, ombra: 1, fire: 2 } },
      { label: "Winter", s: { jpg: 2, fire: 2, anim: 2, ombra: 1 } }
    ]},
    { q: "Your style in a word?", options: [
      { label: "Classic & understated", s: { prada: 2, bdc: 2, wildv: 1, h24: 1 } },
      { label: "Bold & magnetic", s: { sauv: 2, jpg: 2, swy: 2, anim: 1 } },
    ...
    { q: "How much presence do you want?", options: [
      ...
      { label: "Moderate — an arm's length", s: { bdc: 2, then: 2, woodn: 1, wildv: 1, osm: 1, fire: 1 } },
      { label: "Bold — fills the room", s: { sauv: 2, jpg: 2, anim: 2, ombra: 1, swy: 2 } }
    ]},
    { q: "Which note draws you in?", options: [
      { label: "Citrus & bergamot", s: { sauv: 2, bdc: 2, h24: 1, erba: 1, swy: 1 } },
      { label: "Vanilla, amber & spice", s: { jpg: 2, fire: 2, ombra: 1, sauv: 1 } },
      { label: "Vetiver, fig & green leaves", s: { wildv: 2, green: 2, then: 1 } },
      { label: "Leather, tea & musk", s: { anim: 2, osm: 2, then: 1, ombra: 1 } }
    ]},
    { q: "Day or night?", options: [
      { label: "Daytime", s: { h24: 2, green: 2, woodn: 1, prada: 1, wildv: 1, erba: 1 } },
      { label: "After dark", s: { jpg: 2, anim: 2, ombra: 2, fire: 1, osm: 1 } },
      { label: "Both, all the time", s: { bdc: 2, then: 2, sauv: 1, swy: 2, erba: 1 } }
    ]},
