...
(function () {
  ...
  var PRODUCTS = [
    ...
    { name: "YSL Y Iced",            label: "Designer", group: "designer", tier: "designer", notes: "Bergamot · sage · geranium · cedar", image: "assets/img/ysl-y-iced.webp" },
  ...
  var DETAILS = {
    ...
    "ysl-y-iced": { description: "The Y signature read cool — bright bergamot over aromatic sage and geranium, set on dry cedar. Crisp, sharply modern and easy to wear from the morning on.", family: "Aromatic fougère", season: "Spring–Summer", occasion: "Day & office", longevity: "6–8 hrs" },
